		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#espaciolistadomodulolistado-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"espaciolistadomodulolistado-display": {
								"semanticObject": "espaciolistadomodulolistado",
								"action": "display",
								"description": "Aplicación de listado de facturas",
								"title": "listado de facturas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=espaciolistado.modulolistado",
									"url": sap.ui.require.toUrl("espaciolistado/modulolistado")
								}
							}
						}
					}
